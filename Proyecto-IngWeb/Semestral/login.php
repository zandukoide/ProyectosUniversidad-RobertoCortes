...
<body>
    ...
    <h3>Bienvenido!</h3>
        ...
        <div class="social">
            <div onclick="window.location.href = 'registro.php';"> Registrate</div>
        </div>
    </form>
    </body>
    </html>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id_usuario, nombre, rol FROM usuarios WHERE nombre = '$usuario' AND contraseña = '$contrasena'";
